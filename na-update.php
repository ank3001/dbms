...
$sql2 = "select * from north_america where Global_rank=$rank";
...
if(isset($_POST['submit'])){
    ...
    $sql = "update north_america set Global_rank=$rank,Countries='$country',Unemployment_rate=$rate,Available_data='$data_av' where Global_rank=$rank";
