...
$sql2 = "select * from g20 where Global_rank=$rank";
...
if(isset($_POST['submit'])){
    ...
    $sql = "update g20 set Global_rank=$rank,Countries='$country',Unemployment_rate=$rate,Available_data='$data_av' where Global_rank=$rank";
