        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="admin-asia.php" class="active">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Asia</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <a href="asia-row.php"><button type="submit" class="btn btn-primary" name="new_row">Add
                                row</button></a>
                    </div>
                                ...
                                <div class="product">
                                    ...
                                    <div class="right">
                                        <tr>
                                            ...
                                            <td>
                                                <button><a href="asia-update.php?updaterank=<?php echo $tab['Global_rank']?>">Update</a></button>
                                                <button><a href="asia-delete.php?deleterank=<?php echo $tab['Global_rank']?>">Delete</a></button>
                                            </td>
                                        </tr>
                                    </div>
                                </div>
