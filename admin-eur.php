            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <a href="eur-row.php"><button type="submit" class="btn btn-primary" name="new_row">Add
                                row</button></a>
                    </div>
                                ...
                                <div class="product">
                                    ...
                                    <div class="right">
                                        <tr>
                                            ...
                                            <td>
                                                <button><a href="eur-update.php?updaterank=<?php echo $tab['Global_rank']?>">Update</a></button>
                                                <button><a href="eur-delete.php?deleterank=<?php echo $tab['Global_rank']?>">Delete</a></button>
                                            </td>
                                        </tr>
                                    </div>
                                </div>
