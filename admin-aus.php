        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="admin-aus.php"  class="active">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <a href="aus-row.php"><button type="submit" class="btn btn-primary" name="new_row">Add
                                row</button></a>
                    </div>
                                ...
                                <div class="product">
                                    ...
                                    <div class="right">
                                        <tr>
                                            ...
                                            <td>
                                                <button><a href="aus-update.php?updaterank=<?php echo $tab['Global_rank']?>">Update</a></button>
                                                <button><a href="aus-delete.php?deleterank=<?php echo $tab['Global_rank']?>">Delete</a></button>
                                            </td>
                                        </tr>
                                    </div>
                                </div>
